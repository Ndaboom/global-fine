...
{{ Form::open(['route' => 'roles.store', 'method' => 'POST', 'class' => 'max-w-7xl mx-auto py-10 sm:px-6 lg:px-8']) }}
    ...
    <div class="px-4 py-5 bg-white border-left sm:p-6 sm:rounded-tl-md sm:rounded-tr-md md:col-span-1">
        ...
        <div class="col-span-6 sm:col-span-4 uk-margin-bottom">
            ...
            <div class="uk-width-1-1 uk-text-left">
                <label>{{ Form::checkbox('permission[]', $value->id, false, ['class' => 'uk-checkbox uk-margin-right']) }}
                    {{ $value->name }}</label>
            </div>
            @endforeach
        </div>
