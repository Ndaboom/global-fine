            ...
            <div class="row">
                ...
                <div class="col-lg-6 align-self-center">
                    <div class="summary entry-summary">
                        ...
                        {{ Form::open(['method'=>'DELETE', 'route'=>['automobile.vehicule.destroy', $vehicule->id], 'style'=>'display:inline-block']) }}
                        {{ Form::submit('Delete', ['class'=>'octf-btn single_add_to_cart_button btn btn-danger']) }}
                        {{ Form::close() }}

                        {{ Form::open(['method'=>'POST', 'route'=>['automobile.vehicule.toggle_sold', $vehicule->id], 'style'=>'display:inline-block']) }}
                        @method('PUT')
                        {{ Form::submit($vehicule->sold? __('Free vehicule'): __('Vehicule taken'), ['class'=>'octf-btn single_add_to_cart_button btn btn-primary']) }}
                        {{ Form::close() }}
                                    ...
                                    <table class="woocommerce-product-attributes shop_attributes">
                                        <tbody>
                                            ...
                                            <tr>
                                                <th>Model</th>
                                                <td>
                                                    <p>{{ $vehicule->model->title }}</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Fabriqué en </th>
                                                <td>
                                                    <p>{{ $vehicule->made_year }}</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                <th>Status</th>
