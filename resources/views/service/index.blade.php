    ...
    <div class="container">
        ...
        <aside class="widget widget_recent_news">
            ...
            <ul class="recent-news clearfix">
                <li class="clearfix"> 
                    <div class="thumb">
                        <a href=""><img src="images/recent-img-1.jpg" alt=""></a>
                    </div>
                    <div class="entry-header">
                        <h6><a href="">Plan Your Project  with Your Software</a></h6>
                ...
                <li class="clearfix"> 
                    <div class="thumb">
                        <a href=""><img src="images/recent-img-2.jpg" alt=""></a>
                    </div>
                    <div class="entry-header">
                        <h6><a href="">You have a Great  Business Idea?</a></h6>
                        <span class="post-on"><span class="entry-date">November 21, 2019</span></span>
                    </div>
                </li>
                ...
                <li class="clearfix"> 
                    <div class="thumb">
                        <a href=""><img src="images/recent-img-3.jpg" alt=""></a>
                    </div>
                    <div class="entry-header">
                        <h6><a href="">Building Data Analytics  Software</a></h6>
